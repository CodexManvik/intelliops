...
| **[architectural.md](architectural.md)** | **Why the system is shaped this way** — the layer model and twenty-seven ADRs (Architecture Decision Records), each with the context, the decision, the trade-offs, and the alternatives rejected. |
...
- **[architectural.md](architectural.md)** — design principles, the 5→6 layer mapping,
  twenty-seven ADRs, cross-cutting concerns, compliance mapping.
